...
db_server = os.getenv('db_server_sql')
db_user = os.getenv('db_user_sql')
db_pass = os.getenv('db_pass_sql')
...
#get the stocks data
@app.route('/stocks/data',methods=['GET'])
def getStocks():
        args = request.args
        name = args['stock']
        init = args['init']
...
@app.route('/stocks/names',methods=['GET'])
def getNames():
        names_list = []
...
@app.route('/stocks/insert',methods=['POST'])
def insertStocks():
